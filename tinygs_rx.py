...
class tinygs_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.offset = offset = 0.7e6
        self.lora_sf = lora_sf = 8
        self.lora_cr = lora_cr = 5
        self.lora_bw = lora_bw = 250e3
        ...
        self.lora_lora_receiver_0 = lora.lora_receiver(samp_rate, center_freq + offset, [center_freq], int(lora_bw), lora_sf, False, (lora_cr-4), True, False, False, 1, False, False)
...
def main(top_block_cls=tinygs_rx, options=None):
